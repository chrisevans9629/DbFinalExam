...
#if TestDb
        public static string ConnectionStr => @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=FinalDb;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
#else
